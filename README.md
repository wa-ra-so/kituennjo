...
`data/smoking-spots.json` に初期データとして、47都道府県すべての県庁所在地・主要駅周辺の喫煙所を1件以上収録しています（合計217件）。

関東圏は重点的に拡充しており、1都6県すべてで主要駅を個別にカバーしています。主要駅については改札内・エキナカ（エキュート・グランスタ・BECK'S COFFEE SHOPなど、新幹線ホームや商業施設内の喫煙室）も別途収録しています。
