...
- 喫煙所を自分で追加登録（端末のlocalStorageに保存。他の人とは共有されません）。追加ボタンを押すと地図中央に固定されたピンが表示されるので、地図を動かしてピンを実際の場所に合わせてから「ここに追加」で確定します
- 自分で追加した喫煙所は、ピンのポップアップまたは下のリストの「削除」から削除できます（収録データ・OpenStreetMap・Yahoo!ロコ由来のものは削除できません）
...
`data/smoking-spots.json` に初期データとして、47都道府県すべての県庁所在地・主要駅周辺の喫煙所を1件以上収録しています（合計226件）。

関東圏は重点的に拡充しており、1都6県すべてで主要駅を個別にカバーしています。主要駅については改札内・エキナカ（エキュート・グランスタ・BECK'S COFFEE SHOPなど、新幹線ホームや商業施設内の喫煙室）も別途収録しており、仙台・新潟・大阪・岡山・高松・松山・鹿児島中央の各駅についても同様に改札内の喫煙所を調査・収録しています。

| 都県 | 収録件数 | カバー範囲 |
|---|---|---|
| 東京 | 88 | **23区すべて** ＋ 立川市・武蔵野市・町田市（東京駅・新宿駅・池袋駅・上野駅・品川駅のエキナカ含む） |
| 千葉 | 59 | **37市すべて** |
| 神奈川 | 9 | 横浜・川崎・武蔵小杉・藤沢・桜木町（横浜駅エキナカ含む） |
| 埼玉 | 5 | 大宮・川口・所沢・川越（大宮駅新幹線ホーム含む） |
| 茨城 | 2 | 水戸・つくば |
| 栃木 | 2 | 宇都宮・小山 |
| 群馬 | 2 | 前橋・高崎 |
